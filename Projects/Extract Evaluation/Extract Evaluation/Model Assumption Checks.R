...
model_performance(zi_gamma_model)
model_performance(lmer_model) 
...
check_model(zi_gamma_model)
check_model(zi_gamma_model_int)
check_model(zi_gamma_model_zi)
check_model(zi_gamma_model_int_zi)
